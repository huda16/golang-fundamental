...
type Recipes struct {
	...
	User        *Users     `gorm:"foreignKey:UserID" json:"user" form:"user"`
	Comments    []Comments `gorm:"foreignKey:RecipeID" json:"comments" form:"comments"`
	Likes       []Likes    `gorm:"foreignKey:RecipeID" json:"likes" form:"likes"`
}
